document.getElementById("submit_review").onclick=function(){
  ...
  let price_rating=
    document.getElementById("price_rating").value;
  let preferences=
    document.getElementById("preferences").value;
  let specialOccasion=
    document.getElementById("specialOccasion").value;
  let timing=
    document.getElementById("timing").value;
  let good_review=
    document.getElementById("good_review").value;
  let negative_review=
    document.getElementById("negative_review").value;
